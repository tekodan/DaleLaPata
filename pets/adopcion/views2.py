...
from adopcion.forms import LoginForm, RegisterForm, UpdateUserForm, UsersPasswordRecoveryForm, UsersPasswordResetForm
...
class CreateUserView(CreateView):
    ...
    template_name = 'adopcion/home.html'
    #authenticated_redirect_url = reverse_lazy('meupet:index')

    msg = _('Te has postulado con exito, contactate con la fundacion, los datos llegaran a tu mail')
