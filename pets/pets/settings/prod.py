...
#SECRET_KEY = config('$&0=t8mfjh8^92de0kyyh!8)=tnh$r$5#kzou+d!-^q#-fd^cq')
...
#default_db_url = config('postgres://postgres:password@127.0.0.1:5432/pets')
DATABASES = {
...
>>>>>>> 23a3d9fdf8cd72787dd50db4c571b9912879141a
