    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firma', models.ImageField(blank=True, help_text='Maximo tamaño de imagen 8mb', null=True, upload_to='users_firmas')),
                ('foto', models.ImageField(blank=True, help_text='Maximo tamaño de imagen 8mb', null=True, upload_to='users_profiles')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_fundacion', models.DateTimeField(blank=True, default=datetime.datetime(2018, 10, 4, 23, 10, 16, 319258, tzinfo=utc), null=True)),
